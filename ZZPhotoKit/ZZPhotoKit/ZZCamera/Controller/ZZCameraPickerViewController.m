...
- (void)makeDownViewUI
{
    ...
    if (_themeColor) {
        ...
        _downView.backgroundColor = [[UIColor blackColor] colorWithAlphaComponent:0.5];
    }
...
- (NSInteger)collectionView:(UICollectionView *)collectionView numberOfItemsInSection:(NSInteger)section{
    UIButton *doneButton=[_downView viewWithTag:2017];
    doneButton.enabled=self.cameraArray.count>0;
