...
-(void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event{
    if ([self.subviews containsObject:_focus]) {
        [self hideFocusView];
    }
    ...
    _timer = [NSTimer scheduledTimerWithTimeInterval:1.5f target:self selector:@selector(hideFocusView) userInfo:nil repeats:YES];
